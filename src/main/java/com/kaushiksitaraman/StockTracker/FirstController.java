...
public class FirstController {
	    ...
	    {	
	    	...
	    	try {
				...
				data_conn.setBse_Names(entrydb.getName(bseconn, "BSE"));
				data_conn.setBse_Symbols(entrydb.getSymbol(bseconn, "BSE"));
				...
				data_conn.setNse_Names(entrydb.getName(nseconn, "NSE"));
				data_conn.setNse_Symbols(entrydb.getSymbol(nseconn, "NSE"));
